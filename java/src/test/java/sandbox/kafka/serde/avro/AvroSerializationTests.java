...
public class AvroSerializationTests {
  ...
  public void serdeWithSameWriterAndReaderSchema() {
    ...
    Serializer<Object> serializer =
        new AvroSerializer(new KafkaAvroSerializer(schemaRegistryClient));
    serializer.configure(configs, false);

    Deserializer<Object> deserializer =
        new AvroDeserializer(new KafkaAvroDeserializer(schemaRegistryClient));
  ...
  public void serdeWithDifferentWriterAndReaderSchema() {
    ...
    // when
    byte[] serialized = serializer.serialize("topic", thingy);
    ThingyWithoutFoo deserialized =
        (ThingyWithoutFoo) deserializer.deserialize("topic", serialized);
